...
- [Medium — 50 Real-World AI Agent Use Cases](https://medium.com/@annie_7775/50-real-world-ai-agent-use-cases-that-actually-work-73a544c160a2)
- [Oracle](https://www.oracle.com/artificial-intelligence/ai-agents/ai-agent-use-cases/)

## Healthcare

<!-- id: healthcare; type: use-case -->

## Financial Services

<!-- id: financial-services; type: use-case -->

## Retail

<!-- id: retail; type: use-case -->

## Manufacturing

<!-- id: manufacturing; type: use-case -->
...
<!-- id: real-estate; type: use-case -->

## Media & Gaming

<!-- id: media-gaming; type: use-case -->

## Education

<!-- id: education; type: use-case -->
...
<!-- id: hospitality; type: use-case -->

## Telecom

<!-- id: telecom; type: use-case -->
